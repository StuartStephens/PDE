...
vim.keymap.set('n', '<leader>nw', '<cmd>Neorg workspace notes<CR>', { desc = 'Neorg notes workspace' })
vim.keymap.set('n', '<leader>nh', '<cmd>Neorg workspace hugo<CR>', { desc = 'Neorg Hugo workspace' })
vim.keymap.set('n', '<leader>nt', '<Plug>(neorg.qol.todo-items.todo.task-cycle)', { desc = 'Neorg cycle todo' })
vim.keymap.set('n', '<leader>ne', '<cmd>NeorgExportToMarkdown<CR>', { desc = 'Neorg export markdown' })
